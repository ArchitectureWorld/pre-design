...
process.chdir(root)
const out=path.join(root,'work/ui-review-r2/bundle')
...
const html=`<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light dark"><title>Pre-Design · 2.0.2 R2 · 交互预览</title><style>
...
const destination=path.resolve(process.argv[2]??'work/ui-review-r2/pre-V2.0.2-R2-preview.html')
