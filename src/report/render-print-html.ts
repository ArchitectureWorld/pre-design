...
export async function renderPrintHtml(
  ...
  const html = `<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="preplan-project-id" content="${escapeHtml(context.identity.projectId)}"><meta name="preplan-source-revision" content="${context.identity.sourceRevision}"><meta name="preplan-recommendation-id" content="${escapeHtml(context.identity.recommendationId)}"><meta name="preplan-adopted-assets" content="${escapeHtml(adoptedAssets)}"><title>${escapeHtml(context.report.identity.reportTitle)}｜打印版</title><style>@page{size:A4 landscape;margin:0}*{box-sizing:border-box}body{margin:0;color:#${colors.ink};font-family:${fonts}}.print-page{position:relative;width:297mm;height:210mm;padding:17mm 18mm 16mm;display:grid;grid-template-columns:7fr 5fr;gap:10mm;align-items:center;overflow:hidden;break-after:page;background:#${colors.background}}.print-page.no-media{grid-template-columns:1fr}.print-page.no-media .page-copy{max-width:245mm}.print-page.no-media .page-media{display:none}.print-page:last-child{break-after:auto}.layout-full-bleed{color:#${colors.surface};background:#${colors.ink}}.visual-evidence{grid-template-columns:4fr 8fr;gap:9mm}.visual-evidence .page-copy{align-self:end;padding-bottom:12mm}.visual-evidence .page-copy h1{font-size:25pt}.visual-evidence .focus{font-size:12pt;color:#${colors.surface}}.visual-evidence .evidence li{min-height:auto;padding:3mm 0;background:transparent;color:#${colors.surface};border-left:0;border-top:.3mm solid #${colors.muted}}.visual-evidence .page-media img{max-height:170mm}.page-number{position:absolute;top:8mm;right:18mm;color:#${colors.muted};font-size:9pt}.eyebrow{color:#${colors.accent};font-size:9pt;font-weight:700;letter-spacing:.18em}.page-copy h1{margin:4mm 0 6mm;font-size:28pt;line-height:1.08}.no-media .page-copy h1{max-width:235mm;font-size:32pt}.focus{white-space:pre-line;font-size:16pt;line-height:1.5;color:#${colors.primary}}.no-media .focus{max-width:220mm;font-size:18pt}.layout-full-bleed .focus{color:#${colors.surface}}aside{padding:5mm;background:#${colors.surface};color:#${colors.ink}}aside h3{margin:0 0 3mm;font-size:17pt}.evidence{display:grid;gap:3mm;margin:7mm 0 0;padding:0;list-style:none}.evidence li{display:grid;gap:1.5mm;min-height:22mm;padding:4mm 5mm;background:#${colors.surface};color:#${colors.ink};border-left:2mm solid #${colors.primary};font-size:11pt}.evidence small,.evidence span{color:#${colors.muted};font-size:9pt}.page-media figure{margin:0}.page-media img{display:block;width:100%;max-height:145mm;object-fit:contain}.page-media figcaption{margin-top:2mm;color:#${colors.muted};font-size:8pt}.print-page>footer{position:absolute;left:18mm;right:18mm;bottom:7mm;color:#${colors.muted};font-size:8pt}</style></head><body>${pages}</body></html>`
