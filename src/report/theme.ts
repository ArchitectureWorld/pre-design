...
.kind-visual-evidence{background:var(--ink);color:var(--surface)}.visual-evidence-stage{display:grid!important;grid-template-columns:repeat(12,minmax(0,1fr));gap:32px;align-items:center;min-height:76vh}.visual-evidence-copy{grid-column:1/5;align-self:end;padding-bottom:4vh}.visual-evidence-copy h2{font-size:clamp(36px,4.2vw,60px)}.visual-evidence-copy .lead-copy{color:color-mix(in srgb,var(--surface) 76%,transparent);font-size:18px}.visual-evidence-copy .evidence-list li{padding:14px 0;background:transparent;border:0;border-top:1px solid color-mix(in srgb,var(--surface) 24%,transparent)}.visual-evidence-copy .evidence-list small{color:color-mix(in srgb,var(--surface) 58%,transparent)}.visual-evidence-media{grid-column:5/-1}.visual-evidence-media .page-visual img{height:72vh;max-height:none;object-fit:contain;background:transparent}.visual-evidence-media .page-visual figcaption{color:color-mix(in srgb,var(--surface) 64%,transparent)}
...
@media(max-width:760px){.report-nav{display:none}.report-page{min-height:auto;padding:72px 24px;display:block}.page-count{right:24px}.cover-grid,.content-grid,.product-grid,.visual-evidence-stage{display:block!important}.cover-copy,.cover-grid>.page-visual,.content-grid>div,.product-grid>div,.visual-evidence-copy,.visual-evidence-media{grid-column:auto!important}.cover-grid>.page-visual,.content-grid>div:last-child,.visual-evidence-media{margin-top:32px}.cover-copy h1{font-size:44px}.report-page h2{font-size:36px}.claim-focus,.chapter-stage p{font-size:24px}.comparison{grid-template-columns:1fr}.page-visual img,.visual-evidence-media .page-visual img{height:auto;max-height:none}.report-section{padding:48px 24px}}
