...
- 当前开发分支：`feat/pre-v2.0.1`
- 本轮基线：`6d77306a6229c44419cf3bcb5d8a7a976e24711b`
...
开发验证与正式部署分别验收。安装候选包、重启正式 DSH 前，应展示候选包哈希、测试结果和已知限制，并取得用户对该次部署的确认；本次开发不自动提交、推送或重启正式会话。
